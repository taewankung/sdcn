...
from sdcn.widgets.submenu.fileandfolder import FileAndFolder
...
class SdcnController(BoxLayout):
    ...
    def do_action_document(self):
        ...
        self.sub_manu_layout.add_widget(self.document)
        self.document_button.disabled = True
        if (self.file_button.disabled == True):
            self.sub_manu_layout.remove_widget(self.files)
        elif (self.pic_button.disabled == True):
            self.sub_manu_layout.remove_widget(self.pic)
        elif (self.pdf_button.disabled == True):
            self.sub_manu_layout.remove_widget(self.pdfs)
        elif (self.video_button.disabled == True):
            self.sub_manu_layout.remove_widget(self.video)
        elif (self.music_button.disabled == True):
            self.sub_manu_layout.remove_widget(self.music)
        ...
        if(self.layouts.count == 0):
            self.workflow_layout.add_widget(self.layouts)
            self.layouts.count = 1
    
#     document.test
        
    def do_action_files(self):
        self.sub_manu_layout.add_widget(self.files)
        if (self.document_button.disabled == True):
            self.sub_manu_layout.remove_widget(self.document)
        elif (self.pic_button.disabled == True):
            self.sub_manu_layout.remove_widget(self.pic)
        elif (self.pdf_button.disabled == True):
            self.sub_manu_layout.remove_widget(self.pdfs)
        ...
        self.music_button.disabled = False
        self.video_button.disabled = False
        self.workflow_layout.remove_widget(self.document.layout)
        
    def do_action_pic(self):
        self.sub_manu_layout.add_widget(self.pic)
        if (self.file_button.disabled == True):
            self.sub_manu_layout.remove_widget(self.files)
    ...
    def do_action_pdf(self):
        self.sub_manu_layout.add_widget(self.pdfs)
        if (self.file_button.disabled == True):
            self.sub_manu_layout.remove_widget(self.files)
        elif (self.pic_button.disabled == True):
            self.sub_manu_layout.remove_widget(self.pic)
    ...
    def do_action_video(self):
        self.sub_manu_layout.add_widget(self.video)
        if (self.document_button.disabled == True):
            self.sub_manu_layout.remove_widget(self.document)
    ...
    def do_action_music(self):
        self.sub_manu_layout.add_widget(self.music)
        if (self.document_button.disabled == True):
            self.sub_manu_layout.remove_widget(self.document)
        elif (self.file_button.disabled == True ):
            self.sub_manu_layout.remove_widget(self.files)
